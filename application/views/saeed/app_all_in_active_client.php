...
<script type="text/javascript">
  ...
  if(slc_val==1)
  {
     ...
     window.location="<?php echo base_url()?>Saeed_cont/app_edit_user?id="+slc_id;
  }
  else if(slc_val==2)
  {
  ...
  text: "Once Active, you will not be able to recover this  customer!",
...
.then((willDelete) => {
  ...
  if (willDelete) {
      var myurl='<?php echo base_url('Saeed_cont/app_inactive_cus')?>';
   $.ajax({
          url: myurl,
          method:'POST',
          data: 'id='+slc_id,
