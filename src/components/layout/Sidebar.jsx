...
const IcHeadphones  = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 18v-6a9 9 0 0 1 18 0v6"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/></svg>;
const IcFactory     = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 20a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8l-7 5V8l-7 5V4a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2z"/></svg>;
...
const ADMIN_NAV = [
  ...
  { label: 'Counter Sales',     icon: <IcShoppingBag />, to: '/counter-sales' },
  { label: 'Water Plant',        icon: <IcFactory />,    to: '/plant' },
  { label: 'Expenses',          icon: <IcWallet />,      to: '/expenses' },
  { label: 'Support',           icon: <IcHeadphones />,  to: '/support' },
  { label: 'Subscription',      icon: <IcShield />,      to: '/subscription' },
  { label: 'Profile',           icon: <IcUser2 />,      to: '/profile' },
];
